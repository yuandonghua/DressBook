...
public class QRCodeEncoder {
	...
	public QRCodeEncoder(Context activity, Intent intent, int dimension,
	...
	public QRCodeEncoder(Context activity, String content, int dimension,
			boolean useVCard) throws WriterException {
		this.activity = activity;
		this.dimension = dimension;
		this.useVCard = useVCard;
...
//		}
	...
	private boolean encodeContentsFromZXingIntent(Intent intent) {
		...
		LogUtil.e("formatString:" + formatString);
		format = null;
...
//				title = activity.getString(R.string.contents_text);
	...
	public Bitmap encodeAsBitmap() throws WriterException {
		...
		LogUtil.e("contentsToEncode:" + contentsToEncode);
		if (contentsToEncode == null) {
			return null;
		}
		Map<EncodeHintType, Object> hints = null;
		String encoding = guessAppropriateEncoding(contentsToEncode);
		LogUtil.e("encoding:" + encoding);
		if (encoding != null) {
