...
/**
 * @description 店铺营收记录适配器
 * @author 袁东华
 * @date 2016-3-16
 */
public class DianPuYingShouAdapter extends
		Adapter<DianPuYingShouAdapter.ViewHolder> {
	private OnItemClickListener mOnItemClickListener;
	private OnItemLongClickListener mOnItemLongClickListener;
	private ArrayList<YSJL> mList;

	public DianPuYingShouAdapter(Context mContext, Handler mHandler) {
	...
	private void setContent(final ViewHolder viewHolder, final int position) {
		...
		if (mList != null && mList.size() > position) {
			final YSJL xfjl = mList.get(position);
			if (xfjl != null) {
				viewHolder.title_tv.setText(xfjl.getUserName());
				viewHolder.time_tv.setText(xfjl.getAddTime());
				viewHolder.dp_tv.setText(xfjl.getFranchiseeName());
				viewHolder.ms_tv.setText(xfjl.getReson());
				if ("1".equals(xfjl.getIncomeType())) {
					viewHolder.num_tv.setText("+" + xfjl.getIncome());
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.dpysjl_item, parent, false);
	...
	public void setData(ArrayList<YSJL> mList) {
		this.mList = mList;
	}
	...
	public class ViewHolder extends RecyclerView.ViewHolder implements
		...
		private OnItemClickListener mOnItemClickListener;
		private OnItemLongClickListener mOnItemLongClickListener;
		private TextView title_tv, time_tv, num_tv, dp_tv, ms_tv;
		...
		public ViewHolder(View v, OnItemClickListener itemClick,
			...
			dp_tv = (TextView) v.findViewById(R.id.dp_tv);
