 ...
 */
public class ScrollerNumberPicker2 extends View {
	/** 控件宽度 */
	...
	public ScrollerNumberPicker2(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public ScrollerNumberPicker2(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initData();
	}
