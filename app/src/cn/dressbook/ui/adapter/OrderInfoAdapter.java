 ...
 */
public class OrderInfoAdapter extends Adapter<OrderInfoAdapter.ViewHolder> {
	...
	public OrderInfoAdapter(Context mContext, Handler mHandler) {
		...
		if (mMSTJDataList != null && mMSTJDataList.size() > position) {
			...
			if (mstjData != null) {
				if ("7".equals(state) || "8".equals(state)) {
					viewHolder.ckwl_tv.setVisibility(View.VISIBLE);
				} else {
					viewHolder.ckwl_tv.setVisibility(View.GONE);
				}
				...
				// 点击查看物流
				viewHolder.ckwl_tv.setOnClickListener(new OnClickListener() {

					@Override
					public void onClick(View v) {
						// TODO Auto-generated method stub
						if (mstjData.getUrl() == null
								|| "".equals(mstjData.getUrl())) {
							Toast.makeText(mContext, "暂无物流信息",
									Toast.LENGTH_SHORT).show();
						} else {

							Intent intent = new Intent(mContext,
									LogisticsInfoActivity.class);
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.orderinfo_item, parent, false);
	...
	public class ViewHolder extends RecyclerView.ViewHolder implements
		...
		public ViewHolder(View v, OnItemClickListener itemClick,
			...
			ckwl_tv = (TextView) v.findViewById(R.id.ckwl_tv);
