 ...
 * @description: 滑动选择
 * @author:袁东华
 * @time:2015-9-21上午11:19:10
 */
public class ScrollerNumberPicker3 extends View {
	/** 控件宽度 */
	...
	public ScrollerNumberPicker3(Context context, AttributeSet attrs,
			int defStyle) {
	...
	public ScrollerNumberPicker3(Context context) {
		super(context);
		// TODO Auto-generated constructor stub
		initData();
	}
	 ...
	 * @param data
	 */
	public void setData(ArrayList<String> data, String type) {
		this.dataList = data;
		this.type = type;
		initData();
	}
	...
	private class ItemObject {
		...
		public void drawSelf(Canvas canvas) {
			...
			// 绘制内容
			float qidian = x + controlWidth / 2 - textRect.width() / 2;
			if (qidian < 20.0) {
				qidian = (float) 20.0;
			}
			canvas.drawText(itemText + type, qidian, y + move + unitHeight / 2
