...
public class BirthdayPicker extends LinearLayout {
	...
	private void initData() {
		...
		if (!birthday.equals("未设置") && birthday != null && !birthday.equals("")) {
			...
			position1 = 2015 - Integer.parseInt(year);
	...
	protected void onFinishInflate() {
		...
		LayoutInflater.from(getContext()).inflate(R.layout.birthday_picker,
				this);
		// 获取控件引用
		yearPicker = (ScrollerNumberPicker2) findViewById(R.id.year);
		monthPicker = (ScrollerNumberPicker2) findViewById(R.id.month);
		dayPicker = (ScrollerNumberPicker2) findViewById(R.id.day);
