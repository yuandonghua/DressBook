 ...
 * @version
 */
public class AixinjuanyiAppManager {
	/**
	 * TODO activity栈
	 */
	 ...
	 * TODO 单例
	 */
	private static AixinjuanyiAppManager instance;
	 ...
	 * @see
	 */
	public static AixinjuanyiAppManager getInstance() {

		if (instance == null) {
			instance = new AixinjuanyiAppManager();
		}
		return instance;
	}
