...
import cn.dressbook.ui.adapter.LSTJAdapter.ViewHolder;
...
/**
 * @description 提现记录的适配器
 * @author 袁东华
 * @date 2016-2-22
 */
public class TiXianJiLuAdapter extends Adapter<TiXianJiLuAdapter.ViewHolder> {
	...
	public TiXianJiLuAdapter(Context mContext, Handler mHandler) {
	...
	private void setContent(final ViewHolder viewHolder, final int position) {
		...
		if (mList != null && mList.size() > position) {
			final JYJL jyjl = mList.get(position);
			if (jyjl != null) {
				viewHolder.jne_tv.setText(jyjl.getVary());
				viewHolder.state_tv.setText(jyjl.getReson());
				viewHolder.time_tv.setText(jyjl.getAddTime());
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.txjl_item, parent, false);
	...
	public void setData(ArrayList<JYJL> mList2) {
		this.mList = mList2;
	}
	...
	public class ViewHolder extends RecyclerView.ViewHolder implements
		...
		private OnItemClickListener mOnItemClickListener;
		private OnItemLongClickListener mOnItemLongClickListener;
		private TextView jne_tv, state_tv, time_tv;
		...
		public ViewHolder(View v, OnItemClickListener itemClick,
			...
			jne_tv = (TextView) v.findViewById(R.id.jne_tv);
