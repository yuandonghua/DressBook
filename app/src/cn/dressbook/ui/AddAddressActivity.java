 ...
 * @description: 添加收货地址
 * @author:袁东华
 * @time:2015-9-1下午1:54:30
 */
@ContentView(R.layout.addaddress)
public class AddAddressActivity extends BaseActivity {
    private Context mContext = AddAddressActivity.this;
    ...
    @Event(value = {R.id.back_rl,R.id.save_tv,R.id.defaultaddress_iv,R.id.shdq_et})
        ...
        switch (v.getId()) {
            ...
            case R.id.save_tv:
                ...
                if (consignee == null || "".equals(consignee)) {
                    ...
                    AddressExec.getInstance().addAddress(mHandler,
                            ManagerUtils.getInstance().getUser_id(mContext),
                            defaultAddress, consignee, phone, province, city,
                            district, address, zipcode,
                            NetworkAsyncCommonDefines.ADD_ADDRESS_S,
                            NetworkAsyncCommonDefines.ADD_ADDRESS_F);
                }
    ...
    protected void initView() {
        // TODO Auto-generated method stub
        title_tv.setText("添加收货地址");
        consignee_et.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                // TODO Auto-generated method stub
                // 设置新的光标所在位置
                consignee_et.setSelection(s.length());
        ...
        phone_et.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                // TODO Auto-generated method stub
                // 设置新的光标所在位置
                phone_et.setSelection(s.length());

            }
        });
        shdq_et.addTextChangedListener(new TextWatcher() {
        ...
        address_et.addTextChangedListener(new TextWatcher() {
            ...
            public void afterTextChanged(Editable s) {
                // TODO Auto-generated method stub
                // 设置新的光标所在位置
                address_et.setSelection(s.length());
    ...
    protected void initData() {
        ...
        // AddressExec.getInstance().getCityListFromSD(mHandler,
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                // 添加地址成功
                case NetworkAsyncCommonDefines.ADD_ADDRESS_S:
                    Toast.makeText(mContext, "添加地址成功", Toast.LENGTH_SHORT).show();
                    finish();
                    break;
                // 添加地址失败
                case NetworkAsyncCommonDefines.ADD_ADDRESS_F:
