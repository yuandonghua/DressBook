package cn.dressbook.ui.sweetalert;
...
public class SweetAlertDialog extends Dialog implements View.OnClickListener {
	...
	public SweetAlertDialog(Context context, int alertType) {
		...
		mSuccessLayoutAnimSet.getAnimations().get(0)
	...
	public SweetAlertDialog showCancelButton(boolean isShow, int flag) {
		mShowCancel = isShow;
		mFlag = flag;
		if (mCancelButton != null) {
			mCancelButton.setVisibility(mShowCancel ? View.VISIBLE : View.GONE);
	...
	public SweetAlertDialog showConfirmButton(boolean isShow, int flag) {
		mShowConfirm = isShow;
		mFlag = flag;
		if (mConfirmButton != null) {
			mConfirmButton.setVisibility(mShowConfirm ? View.VISIBLE
					: View.GONE);
		} else {
		}
		return this;
	...
	public SweetAlertDialog setCancelClickListener(int flag,
	...
	public SweetAlertDialog setConfirmClickListener(int flag,
			OnSweetClickListener listener) {
		mConfirmFlag = flag;
	...
	public SweetAlertDialog setHandler(Handler mHandler) {
		// TODO Auto-generated method stub
