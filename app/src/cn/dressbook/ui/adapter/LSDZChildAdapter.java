...
/**
 * @description 量身定制商品展示适配器
 * @author 袁东华
 * @date 2016-1-22
 */
public class LSDZChildAdapter extends Adapter<LSDZChildAdapter.ViewHolder> {
	...
	public LSDZChildAdapter(Context mContext, Handler mHandler) {
	...
	private void setContent(final ViewHolder viewHolder, final int position) {
		...
		if (mList != null && mList.size() > 0) {
			...
			if (dzsp != null) {
//				LogUtil.e("position:" + position + " dzsp.getDzAttire_price():"
//						+ dzsp.getDzAttire_price());
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.lsdzchild_item, parent, false);
	...
	public class ViewHolder extends RecyclerView.ViewHolder implements
		...
		private OnItemClickListener mOnItemClickListener;
		private OnItemLongClickListener mOnItemLongClickListener;
		private TextView title_tv, price2_tv;
