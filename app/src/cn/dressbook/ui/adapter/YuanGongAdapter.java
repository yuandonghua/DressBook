 ...
 * @date 2016-3-16
 */
public class YuanGongAdapter extends
		Adapter<YuanGongAdapter.ViewHolder> {
	private OnItemClickListener mOnItemClickListener;
	private OnItemLongClickListener mOnItemLongClickListener;
	private ArrayList<User> mList;

	public YuanGongAdapter(Context mContext, Handler mHandler) {
	...
	private void setContent(final ViewHolder viewHolder, final int position) {
		...
		if (mList != null && mList.size() > position) {
			final User xfjl = mList.get(position);
			if (xfjl != null) {
				viewHolder.dpname_tv.setText(xfjl.getName());
				viewHolder.time_tv.setText(xfjl.getAddTimeShow());
				viewHolder.phone_tv.setText(xfjl.getPhone());
			}
		} else {
		}
	}
	...
	public ViewHolder onCreateViewHolder(ViewGroup parent, int arg1) {
		...
		View v = LayoutInflater.from(parent.getContext()).inflate(
				R.layout.yuangong_item, parent, false);
	...
	public void setData(ArrayList<User> mList) {
		this.mList = mList;
	}
	...
	public class ViewHolder extends RecyclerView.ViewHolder implements
		...
		private OnItemClickListener mOnItemClickListener;
		private OnItemLongClickListener mOnItemLongClickListener;
		private TextView dpname_tv, time_tv,phone_tv;
		...
		public ViewHolder(View v, OnItemClickListener itemClick,
			...
			dpname_tv = (TextView) v.findViewById(R.id.dpname_tv);
